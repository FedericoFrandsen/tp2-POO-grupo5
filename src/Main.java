        ...
        switch (modificarOption) {
            ...
            case 2:
                ...
                try {
                    ...
                    // El metodo devuelven true si se agregó el jugador por eso lo ponemos directo en el if.
                    if (equipoAModificar.agregarJugador(jugadorAAgregar)) {

                        System.out.println("Jugador agregado: " + jugadorAAgregar.getNombre() + " " + jugadorAAgregar.getApellido());

                    }
                } catch (RuntimeException e) {

                    System.out.println("ID de jugador no válido.");
        ...
        while (continuar) {
            ...
            switch (jugadorOption) {
                ...
                case 2:
                    ...
                    Jugador nuevoJugador = new Jugador(Utilidades.generarIdUnicaEn(jugadores), nombre, apellido, edad, 0, 0);
